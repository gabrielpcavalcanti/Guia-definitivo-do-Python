"""
Escreva um programa de ajuda para os vendendores. A partir de um valor total lido, mostre:
O total a pagar com um desconto de 10%;
O valor de cada parcela, no parcelamento de 3x sem juros;
A comissão do vendedor, no caso da venda ser a vista (5% no valor com desconto);
