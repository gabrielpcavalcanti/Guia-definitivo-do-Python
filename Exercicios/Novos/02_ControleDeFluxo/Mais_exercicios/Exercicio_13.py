...
if num_01 <= num_02 and num_02 <= num_03:
    ...
    print(num_01, num_03, num_02)

elif num_02 <= num_01 and num_01 <= num_03:
    print(num_02, num_01, num_03)

elif num_02 <= num_03 and num_03 <= num_01:
    print(num_02, num_03, num_01)

elif num_03 <= num_01 and num_01 <= num_02:
    print(num_03, num_01, num_02)
    
else:
    print(num_03, num_02, num_01)
